...
import type { Room, Tenant, MeterReadingGroup, Invoice, AdminSettings, User, AdminInvitation, Team } from "@/lib/types"
...
export type SettingsMapperInput = RecordMeta & AdminSettings & {
  teamId: string
}
